    ...
    return (
        <>
            <form onSubmit={onSubmitHandler} className='pt-5 px-5 sm:pt-12 sm:pl-16'>
                ...
                <br />
                <button className='mt-8 w-40 h-12 border border-black shadow-[5px_9px_12px_#000000] transition-all duration-500 hover:bg-black hover:text-white hover:shadow' type='submit'>ADD</button>
            </form>
        </>
    )
}
